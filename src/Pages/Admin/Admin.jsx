...
export default function Admin() {
  ...
  const [retro, setRetro] = useState("não")
  ...
  const handleSubmit = async (e) => {
    ...
    const camisa = { tipo, nome, tamanhos, preco: precoNumerico, clube, paisOrigem, selecao, anoLancamento, imagem: imagemFinal, descricao, versao, retro };
      ...
      <form className={styles.formAdmin} onSubmit={handleSubmit}>
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={retro === "sim"}
              onChange={(e) => setRetro(e.target.checked ? "sim" : "não")}
              sx={{
        ...
        {tipo === "clube" || (tipo === "retro" && !selecao) ? (
          <>
            <div>
              ...
              <input type="text" value={clube} onChange={(e) => setClube(formatClubName(e.target.value))} />
            </div>
            {/*<div>
